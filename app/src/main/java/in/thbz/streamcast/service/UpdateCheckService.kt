package in.thbz.streamcast.service
...
class UpdateCheckService : Service() {
    ...
    companion object {
        ...
        // Actions
        const val ACTION_START = "in.thbz.streamcast.service.action.START"
        const val ACTION_STOP = "in.thbz.streamcast.service.action.STOP"
        const val ACTION_CHECK_NOW = "in.thbz.streamcast.service.action.CHECK_NOW"

        // Broadcast Results
        const val ACTION_UPDATE_RESULT = "in.thbz.streamcast.service.action.UPDATE_RESULT"
